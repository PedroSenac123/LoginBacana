...
public class CadastroUsuarioModel extends LoginModel {
    ...
    public void ResetarSenhaModel(CadastroUsuarioModel senhaResetada){
        GerenciadorBancoDados op = new GerenciadorBancoDados();
        op.resetarSenhaBD(senhaResetada);
    }
    public ArrayList<CadastroUsuarioModel> recuperarDadosUsuarioModel(String id_user) {
        GerenciadorBancoDados oper = new GerenciadorBancoDados();
        return oper.recuperarDadosUsuarioBD(id_user);
    }
}
